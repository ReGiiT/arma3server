...
class CraftConcreteDrawbridge: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Grinder"};                 ////////////////////// added Tools ////// GB //////
};
...
class CraftConcreteFloorPort: Exile_AbstractCraftingRecipe
{
	...
	returnedItems[] = 
	{
		...
		{2, "Exile_Item_WaterCanisterEmpty"},
		{0, "Exile_Item_FuelCanisterEmpty"}
	};
	components[] = 
	{
		{4, "Exile_Item_Cement"},
...
class CraftFortificationUpgrade: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Grinder","Exile_Item_Pliers","Exile_Item_Screwdriver"}; ///added   ////////// GB ////
};
class CraftHBarrier5Kit: Exile_AbstractCraftingRecipe
{
	...
	tools[] = 
	{
		"Exile_Item_Pliers","Exile_Item_Grinder"                             ////////////////// added grinder GB //////
	};
	returnedItems[] = 
	{
...
class CraftMetalBoard: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Grinder","Exile_Item_Pliers"};     ////////////////// ADDED Exile_Item_Pliers //// GB //////
};
...
class CraftStorageCrate: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Screwdriver","Exile_Item_Pliers","Exile_Item_Handsaw"};           //////// added Exile_Item_Screwdriver Exile_Item_Handsaw// GB //////
};
...
class CraftWoodDoorWay: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Handsaw"};                        ////////////////////// added /////tools[]/////
}	
...
class CraftWoodFloor: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Handsaw"};                             /////// added tools[] = {"Exile_Item_Handsaw"};/////
};
...
class CraftWoodStairs: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Handsaw"};                            ////////////////////// added tools[] = {"Exile_Item_Handsaw"}; GB //////
};
...
class UpgradeToConcreteDoor: Exile_AbstractCraftingRecipe
{
	...
	components[] = 
	{
		...
		{2, "Exile_Item_MetalScrews"}                                   ///// added screws /// GB ////
	};
	tools[] = {"Exile_Item_Pliers"};                                   //////////// added tools[] = {"Exile_Item_pliers"}; /////// GB ////
};
class UpgradeToConcreteFloorPort: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Pliers","Exile_Item_Grinder"};                              //////////////tools[] = {"Exile_Item_Grinder","Exile_Item_Pliers"};
};
...
class UpgradeToConcreteWindow: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Grinder","Exile_Item_Pliers"};       ////////////////////// added ////
};
class UpgradeToWoodDoor: Exile_AbstractCraftingRecipe
{
	...
	tools[] = {"Exile_Item_Handsaw"};                     //////////////////////////// added ////////
};
...
class CfgExileCustomCode 
{
	...
	*/
    ...
    ExileServer_system_territory_database_load      = "ExAdClient\VirtualGarage\CustomCode\ExileServer_system_territory_database_load.sqf";	//Enigma Revive
	...
	exileclient_system_lootmanager_thread_spawn = "EBM\exileclient_system_lootmanager_thread_spawn.sqf";                             // EBM loot spawn fix     GB
...
class CfgInteractionMenus
{
	...
	class Car 
	{
		...
		class Actions 
		{
			...
			class PackDeployedVehicle: ExileAbstractAction  //ExAd
			{
				title = "Pack Vehicle";
	...
	*/
	...
	class Flag
	{
		...
		class Actions
		{
			...
			*/
			/*
			class HackVG : ExileAbstractAction    //ExAd
			{
	...
	class Player 
	{
		...
		class Actions 
		{
			...
			class Revive: ExileAbstractAction // Enigma exile Rivive
			{
				title = "Perform CPR"; 
...
class CfgTerritories
{
	...
	prices[] = 
	{
		...
		{55000,					75,			150					}, // Level 5
		{65000,					90,			180					}, // Level 6
		{75000,					105,		210					}, // Level 7
		{80000,					120,		240					}, // Level 8
		{90000,					135,		270					}, // Level 9
	 ...
	 * cannot build territories
	 */
	minimumDistanceToSpawnZones = 400;
...
class CfgTrading 
{
	...
	* in CfgExileArsenal. 
	*/
	sellPriceFactor = 0.50;
	
	rekeyPriceFactor = 0.1;

	class requiredRespect                           /////////////////////// changed GB /////////
	{
		Level1 = 1000;                             // was 0 ///
		Level2 = 5500;                             //   was 2500 //
		Level3 = 10000;                             // was 5000 //
		Level4 = 30000;                            // was 10000 ///
		Level5 = 55000;                             // was 20000 //
		Level6 = 65000;                             // was 25000 //
	};
};
...
class CfgXM8 
{
	extraApps[] = {"ExAd_Mozzie","ExAd_JX","ExAd_Info","ExAd_CHVD","ExAd_VG","BRAmaRecipes","BaseMarker","ExAd_SB","ExAd_Quad","ExAd_Unit"};
...
class CfgXM8
{
	extraApps[] = {"ExAd_VG","ExAd_Info","ExAd_CHVD","ExAd_Journal","ExAd_Quad","ExAd_SB"}; //"ExAd_Bike"
	...
	class ExAd_Bike
	{
		...
		comment "Exported from Arsenal by Daemon";
...
this addItemToVest "Exile_Item_ExtensionCord";
this addItemToVest "Exile_Item_PlasticBottleEmpty";
